calculateLinearMLE=function(snp,formula_tofit,model,data,bim,lolim,hilim,m,bse,k,robust,family){
  ...
  # Now we need to set the grid range when it's not inputted
